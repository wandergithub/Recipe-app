...
RSpec.describe 'Recipe Food page', type: :feature do
    ...
    before :each do
        @user = User.create!(name: 'Hana', email: 'hana@gmail.com', password: '1234567', password_confirmation: '1234567')
    ...
    it 'should be able to see Foods' do
      ...
      it "shouldn't be able to remove if you are not the owner of the recipe" do
        @user2 = User.create!(name: 'Abebe', email: 'abebe@csc.et', password:'1234567', password_confirmation: '1234567')
